...
return new class extends Migration
{
    ...
    {
        Schema::create('institution_answers', function (Blueprint $table) {
            $table->id();
            $table->foreignId('attempt_id')->constrained('institution_attempts')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('institution_answers');
    }
};
