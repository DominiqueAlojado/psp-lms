...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasColumn('roles', 'team_id')) {
            ...
            try {
                DB::statement('ALTER TABLE roles DROP CONSTRAINT roles_team_id_name_guard_name_unique');
            } catch (\Exception $e) {
                //
            }
        ...
        if (Schema::hasColumn('model_has_permissions', 'team_id')) {
            try {
                if (DB::getDriverName() !== 'sqlite') {
                    DB::statement('ALTER TABLE model_has_permissions DROP CONSTRAINT model_has_permissions_permission_id_foreign');
                }
            } catch (\Exception $e) {
                //
            }
            ...
            try {
                DB::statement('DROP INDEX model_has_permissions_team_foreign_key_index');
            } catch (\Exception $e) {
                //
            }
        ...
        if (Schema::hasColumn('model_has_roles', 'team_id')) {
            try {
                if (DB::getDriverName() !== 'sqlite') {
                    DB::statement('ALTER TABLE model_has_roles DROP CONSTRAINT model_has_roles_role_id_foreign');
                }
            } catch (\Exception $e) {
                //
            }
            ...
            try {
                DB::statement('DROP INDEX model_has_roles_team_foreign_key_index');
            } catch (\Exception $e) {
                //
            }
