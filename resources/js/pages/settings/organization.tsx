                                ...
                                <TableBody>
                                    {residents.map((resident) => (
                                        <TableRow key={resident.id}>
                                            ...
                                            <TableCell>{resident.year_level}</TableCell>
                    ...
                    <SheetContent className="sm:max-w-[600px] overflow-y-auto p-0">
                        <div className="p-6">
                            <SheetHeader className="pb-6">
                                ...
                                <SheetDescription>
                                    Update resident information and account settings
                                </SheetDescription>
                            </SheetHeader>

                            {editingResident && (
                                <Form
                                    action={`/settings/organization/residents/${editingResident.id}`}
                                    method="patch"
                                        ...
                                        <Tabs defaultValue="personal" className="w-full">
                                                ...
                                                <div className="grid gap-4 md:grid-cols-2">
                                                    <div className="space-y-2">
                                                        ...
                                                        <select
                                                            ...
                                                            required
                                                        >
                                                            <option value="Pre-Resident">Pre-Resident</option>
                                            ...
                                            <TabsContent value="account" className="space-y-6 pt-2">
                                                <div className="rounded-lg border border-muted bg-muted/50 p-4">
                                                    <p className="text-sm text-muted-foreground">
                                                        Change the resident's account password. Leave blank to keep the current password.
                                                    </p>
                                                </div>
