...
use App\Repositories\Eloquent\GradebookRepository;
...
use App\Repositories\Eloquent\RolesPermissionsRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(GradebookRepositoryInterface::class, GradebookRepository::class);
